...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    patientEnrollmentProgramAuthUserSubject.add(
      PatientEnrollmentProgramAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PatientEnrollmentProgramAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PatientEnrollmentProgramAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PatientEnrollmentProgramAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    patientEnrollmentProgramAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
PatientEnrollmentProgramAuthUser? currentUser;
