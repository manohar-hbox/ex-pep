...
import 'g_s_patient_detail_model.dart';
export 'g_s_patient_detail_model.dart';

class GSPatientDetailWidget extends StatefulWidget {
  const GSPatientDetailWidget({
    super.key,
  ...
  static String routeName = 'GSPatientDetail';
  static String routePath = 'GSPatientDetails';

  @override
  State<GSPatientDetailWidget> createState() => _GSPatientDetailWidgetState();
}

class _GSPatientDetailWidgetState extends State<GSPatientDetailWidget> {
  late GSPatientDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GSPatientDetailModel());
                              ...
                              if (true /* Warning: Trying to access variable not yet defined. */)
                                Align(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: FFAppState()
                                        .globalSearchPatientCallDetails(
                                      requestFn: () =>
                                                      ...
                                                      Align(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FutureBuilder<
                                                              ApiCallResponse>(
                                                            future: FFAppState()
                                                                .listOfCareSpecialistCallStatus(
                                                              requestFn: () =>
                                                                  GQLgetByFunctionCall
                                                                      .call(
                                                                hasuraToken:
                                                                    FFAppState()
                                                                        .hasuraToken,
                                                                requestBody:
                                                                    '{\"query\":\"query MyQuery {pep_care_specialist_call_status_mapping(order_by: {id: asc}) { id call_status }}\"}',
                                                              ),
                                                            ),
                                                            builder: (context,
                                                                snapshot) {
                                                              ...
                                                              final callStatusCSGQLgetByFunctionResponse =
                                                                  snapshot
                                                                      .data!;
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                ...
                                                                options: List<
                                                                        int>.from(
                                                                    getJsonField(
                                                                  callStatusCSGQLgetByFunctionResponse
                                                                      .jsonBody,
                                                                  r'''$.data.pep_care_specialist_call_status_mapping[:].id''',
                                                                  true,
                                                                )!),
                                                                optionLabels:
                                                                    (getJsonField(
                                                                  callStatusCSGQLgetByFunctionResponse
                                                                      .jsonBody,
                                                                  r'''$.data.pep_care_specialist_call_status_mapping[:].call_status''',
                                                                  true,
                                                                ) as List)
                                                                        .map<String>((s) =>
                                                                            s.toString())
                                                                      ...
                                                                      future: FFAppState()
                                                                        ...
                                                                        requestFn:
                                                                          ...
                                                                          hasuraToken:
                                                                              FFAppState().hasuraToken,
                                                                          requestBody: functions
                                                                              .getAppointmentDates(widget.clinicID!)
                                                                              .toString(),
                                                                        ),
                                                                      ),
                                                                      builder:
                                                                            ...
                                                                            if (getJsonField(
                                                                              ...
                                                                              Align(
                                                                                ...
                                                                                child: FlutterFlowDropDown<String>(
                                                                                  controller: _model.nextAppDateCSValueController ??= FormFieldController<String>(
                                                                                    _model.nextAppDateCSValue ??= '',
                                                                                  ),
                                                                                  ...
                                                                                  optionLabels: (getJsonField(
                                                                                    ...
                                                                                    true,
                                                                                      ...
                                                                                      .toList(),
                                                                                  onChanged: (val) async {
                                                                                    safeSetState(() => _model.nextAppDateCSValue = val);
                                                                        ...
                                                                        child: FutureBuilder<
                                                                          ...
                                                                          future:
                                                                            ...
                                                                            requestFn: () =>
                                                                                GQLgetByFunctionCall.call(
                                                                              hasuraToken: FFAppState().hasuraToken,
                                                                              requestBody: functions.getAppointmentTimes(widget.clinicID!, _model.nextAppDateCSValue!).toString(),
                                                                            ),
                                                                          ),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            ...
                                                                            final nextAppTimeCSGQLgetByFunctionResponse =
                                                                                snapshot.data!;

                                                                            return FlutterFlowDropDown<String>(
                                                                              controller: _model.nextAppTimeCSValueController ??= FormFieldController<String>(
                                                                                _model.nextAppTimeCSValue ??= '',
                                                                              ),
                                                                              options: List<String>.from((getJsonField(
                                                                                nextAppTimeCSGQLgetByFunctionResponse.jsonBody,
                                                                              ...
                                                                              optionLabels: (getJsonField(
                                                                                ...
                                                                                true,
                                                                                  ...
                                                                                  .map<String>((s) => s.toString())
                                                                                  .toList(),
                                                                              onChanged: (val) => safeSetState(() => _model.nextAppTimeCSValue = val),
                                                                              width: 160.0,
                                                                              height: 50.0,
                                                                              textStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    font: GoogleFonts.readexPro(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child:
                                                              ...
                                                              decoration:
                                                                  InputDecoration(
                                                                hintText:
                                                                    'No Answer from the Patient Scheduled next Appointment on 5th March.',
                                                                hintStyle: FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelSmall
                                                                    .override(
