...
import '/index.dart';
import 'c_s_patient_detail_saved_widget.dart' show CSPatientDetailSavedWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class CSPatientDetailSavedModel
    extends FlutterFlowModel<CSPatientDetailSavedWidget> {
  ...
  // Stores action output result for [Backend Call - API (Update Timer Log)] action in CSPatientDetailSaved widget.
  ApiCallResponse? updateTimerPageLoad;
  // Stores action output result for [Custom Action - isTabMinimized] action in CSPatientDetailSaved widget.
  bool? isTabMinimized;
