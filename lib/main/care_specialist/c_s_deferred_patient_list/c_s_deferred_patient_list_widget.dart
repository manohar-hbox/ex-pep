...
import 'c_s_deferred_patient_list_model.dart';
export 'c_s_deferred_patient_list_model.dart';

class CSDeferredPatientListWidget extends StatefulWidget {
  const CSDeferredPatientListWidget({super.key});

  static String routeName = 'CSDeferredPatientList';
  static String routePath = 'CSDeferredPatientList';

  @override
  State<CSDeferredPatientListWidget> createState() =>
      _CSDeferredPatientListWidgetState();
}

class _CSDeferredPatientListWidgetState
    extends State<CSDeferredPatientListWidget> {
  late CSDeferredPatientListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSDeferredPatientListModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().loginToken != '') {
        ...
        _model.csDeferredPatientList = [];
        _model.csDeferredPatientListFiltered = [];
        _model.pageLoad = false;
        safeSetState(() {});
        if (!(_model.csDeferredPatientList.isNotEmpty)) {
          _model.csPatientDeferredListAPICallPageLoad =
              await GQLgetByFunctionCall.call(
            hasuraToken: FFAppState().hasuraToken,
            requestBody:
                functions.getCareSpecialistDeferredPatientList().toString(),
          );

          FFAppState().isCSView = true;
          safeSetState(() {});
          _model.csDeferredPatientList = functions
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Care Specialist (CS) - Deferred Patients',
                  ...
                  children: [
                    if (!(_model.csDeferredPatientList.isNotEmpty))
                      Align(
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Text(
                          'There are no patients available in the Deferred List!',
                          style:
                              ...
                              Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    controller: _model
                                            .csDeferredFilterDropDownValueController ??=
                                        FormFieldController<String>(
                                      _model.csDeferredFilterDropDownValue ??=
                                          (FFAppState()
                                  ...
                                  if (!((_model.csDeferredFilterDropDownValue ==
                                          'dob') ||
                                      (_model.csDeferredFilterDropDownValue ==
                                          'clinic_time_appointment')))
                                    Container(
                                            ...
                                            if (!((_model
                                              ...
                                              if ((String? searchString) {
                                                return searchString == null
                                                  ...
                                                  .text)) {
                                                _model.csDeferredPatientListFiltered = functions
                                                    .filterCSListLocally(
                                                        _model
                                                            .csDeferredPatientList
                                                            .toList(),
                                                        _model
                                                            .csDeferredFilterDropDownValue,
                                                        _model
                                                ...
                                                safeSetState(() {});
                                                FFAppState()
                                                        .csFilterDeferredDropDownContent =
                                                    (_model.searchStringFocusNode
                                                                ?.hasFocus ??
                                                            false)
                                                        .toString();
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      _model.csPatientDeferredListAPICallReLoadButton =
                                          await GQLgetByFunctionCall.call(
                                        hasuraToken: FFAppState().hasuraToken,
                                        requestBody: functions
                                            .getCareSpecialistDeferredPatientList()
                                            .toString(),
                                      );
                        ...
                        Expanded(
                          child: Stack(
                            children: [
                              ...
                              if (!(_model.csDeferredPatientListFiltered
                                      .isNotEmpty) &&
