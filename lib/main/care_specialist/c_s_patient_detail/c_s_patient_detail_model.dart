...
import '/index.dart';
import 'c_s_patient_detail_widget.dart' show CSPatientDetailWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class CSPatientDetailModel extends FlutterFlowModel<CSPatientDetailWidget> {
  ...
  bool isEnrolledForCCM = false;

  bool isEnrolledForRPM = false;
  ...
  // Stores action output result for [Backend Call - API (Create Patient Timer Log)] action in CSPatientDetail widget.
  ApiCallResponse? createPatientTimeButtonCSLog;
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in CSPatientDetail widget.
  ApiCallResponse? getIfPatientCanMakeOutgoingCallResponse;
  InstantTimer? instantTimer;
  // Stores action output result for [Custom Action - isTabMinimized] action in CSPatientDetail widget.
  bool? isTabMinimized;
  // Stores action output result for [Backend Call - API (Update Timer Log)] action in CSPatientDetail widget.
  ApiCallResponse? updateTimerPageLoad;
  // Stores action output result for [Backend Call - API (Update Patient Timer Log)] action in CSPatientDetail widget.
