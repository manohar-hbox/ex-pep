...
import 'c_s_patient_detail_model.dart';
export 'c_s_patient_detail_model.dart';

class CSPatientDetailWidget extends StatefulWidget {
  const CSPatientDetailWidget({
    super.key,
    required this.patientClinicDataID,
    required this.clinicID,
    required this.cSScreenType,
  });
  ...
  static String routeName = 'CSPatientDetail';
  static String routePath = 'CSPatientDetails';

  @override
  State<CSPatientDetailWidget> createState() => _CSPatientDetailWidgetState();
}

class _CSPatientDetailWidgetState extends State<CSPatientDetailWidget>
    with TickerProviderStateMixin {
  late CSPatientDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSPatientDetailModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().loginToken != '') {
        _model.createPatientTimeButtonCSLog =
        ...
        if ((_model.createPatientTimeButtonCSLog?.succeeded ?? true)) {
          _model.patientTimerLogId = PEPAPIsGroup.createPatientTimerLogCall
              .timeLogId(
                (_model.createPatientTimeButtonCSLog?.jsonBody ?? ''),
              )
              ?.toString();
          safeSetState(() {});
        }
        ...
        safeSetState(() {});
        FFAppState().isPaused = !(FFAppState().isPaused ?? true);
        safeSetState(() {});
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'Care Specialist (CS) - Patient Details',
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (_model
                                                                        ...
                                                                        _model.outboundNumbers = _model
                                                                            .listOfProcessedOutboundNo!
                                                                            .toList()
                                                                            .cast<String>();
                                                                        safeSetState(
                                                                            () {});
                                            ...
                                            children: [
                                              FutureBuilder<ApiCallResponse>(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  final c1GQLgetByFunctionResponse =
                                                      snapshot.data!;
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: FutureBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final c2GQLgetByFunctionResponse =
                                                                      snapshot
                                                                          .data!;
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        if (GQLgetByFunctionCall.ccmStatusUpdates(
                                                                                  c2GQLgetByFunctionResponse.jsonBody,
                                                                                ) !=
                                                                                null &&
                                      ...
                                      children: [
                                        ...
                                        if ((_model.ccmStatus != (10)) &&
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                'Set only if wish to update the current appointment date and time',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                                                    .override(
                                                      ...
                                                      requestFn: () =>
                                                        ...
                                                        hasuraToken:
                                                            FFAppState()
                                                                .hasuraToken,
                                                        requestBody:
                                                            '{\"query\":\"query MyQuery {pep_v2_status_mapping_rpm(where: {cs: {_eq: true}}, order_by: {id: asc}) { id status }}\"}',
                                                      ),
                                                    ),
                                                    builder:
                                                        (context, snapshot) {
                                        ...
                                        children: [
                                                          ...
                                                          if ((_model.ccmStatus !=
                                                            ...
                                                            if (_model.commentTextController
                                                              ...
                                                              if (((((_model.ccmStatus == (1)) ||
                                                                  ...
                                                                  (((_model.rpmStatus ==
                                                                              (2)) &&
                                                                          ((_model.facilityValue != null) &&
                                                                              (_model.rPMAppDateValue != null && _model.rPMAppDateValue != '') &&
                                                                              (_model.rPMAppTimeValue != null && _model.rPMAppTimeValue != ''))) ||
                                                                      (_model.rpmStatus != (2)))) {
                                                                if (_model
                                                            ...
                                                            ScaffoldMessenger
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  'The CCM status need to be updated',
                                                                  style: GoogleFonts
                                                                      .poppins(
                                                                    color: FlutterFlowTheme.of(
                                                                            context)
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              FFAppState()
                                                  .clearCcmStatusUpdatesCSCache();
                                              FFAppState()
                                                  .clearRpmStatusUpdatesCSCache();
                                              FFAppState()
                                              ...
                                              if (widget.cSScreenType ==
                                                  CSScreenType.PatientList) {
                                                context.goNamed(
