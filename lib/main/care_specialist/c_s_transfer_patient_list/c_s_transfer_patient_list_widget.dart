...
import 'c_s_transfer_patient_list_model.dart';
export 'c_s_transfer_patient_list_model.dart';

class CSTransferPatientListWidget extends StatefulWidget {
  const CSTransferPatientListWidget({super.key});

  static String routeName = 'CSTransferPatientList';
  static String routePath = 'CSTransferPatientList';

  @override
  State<CSTransferPatientListWidget> createState() =>
      _CSTransferPatientListWidgetState();
}

class _CSTransferPatientListWidgetState
    extends State<CSTransferPatientListWidget> {
  late CSTransferPatientListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSTransferPatientListModel());
