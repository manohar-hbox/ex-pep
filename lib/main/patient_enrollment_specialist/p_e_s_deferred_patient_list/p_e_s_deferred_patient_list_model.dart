...
import '/index.dart';
import 'p_e_s_deferred_patient_list_widget.dart'
    show PESDeferredPatientListWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class PESDeferredPatientListModel
    extends FlutterFlowModel<PESDeferredPatientListWidget> {
  ...
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in PESDeferredPatientList widget.
  ApiCallResponse? pesPatientDeferredListAPICallPageLoad;
  InstantTimer? instantTimer;
  // Stores action output result for [Backend Call - API (Update Timer Log)] action in PESDeferredPatientList widget.
  ApiCallResponse? updateTimerPageLoad;
  // Stores action output result for [Custom Action - isTabMinimized] action in PESDeferredPatientList widget.
  bool? isTabMinimized;
