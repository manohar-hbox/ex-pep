...
import 'v_p_e_dashboard_widget.dart' show VPEDashboardWidget;
import 'package:flutter/material.dart';

class VPEDashboardModel extends FlutterFlowModel<VPEDashboardWidget> {
  ///  Local state fields for this page.

  int? ccmStatus;

  bool? selectGroupSeen;

  bool checkTaskAssigned = false;
  ...
  bool canClinicMakeOutgoingCall = false;

  int? patientTimerState = 0;

  String? patientTimerLogId;

  List<String> outboundNumbers = ['13026006476', '17344071713'];
  ...
  // Stores action output result for [Backend Call - API (Create Patient Timer Log)] action in VPEDashboard widget.
  ApiCallResponse? createPatientTimeButtonVPELog;
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in VPEDashboard widget.
  ApiCallResponse? enrollementSpecialist;
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in VPEDashboard widget.
  ApiCallResponse? getAssignedGroups;
  InstantTimer? instantTimer;
  // Stores action output result for [Custom Action - isTabMinimized] action in VPEDashboard widget.
  bool? isTabMinimized;
  // Stores action output result for [Backend Call - API (Update Timer Log)] action in VPEDashboard widget.
  ApiCallResponse? updateTimerPlayButtonVPE;
  // Stores action output result for [Backend Call - API (Update Patient Timer Log)] action in VPEDashboard widget.
  ...
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in Group widget.
  ApiCallResponse? nextPatientByGroup;
  ...
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in Button widget.
  ApiCallResponse? nextPatientCall;
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in Button widget.
