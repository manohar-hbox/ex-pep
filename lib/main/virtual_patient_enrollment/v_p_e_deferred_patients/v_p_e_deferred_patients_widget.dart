...
import 'v_p_e_deferred_patients_model.dart';
export 'v_p_e_deferred_patients_model.dart';

class VPEDeferredPatientsWidget extends StatefulWidget {
  const VPEDeferredPatientsWidget({
    super.key,
  ...
  static String routeName = 'VPEDeferredPatients';
  static String routePath = 'VPEDeferredPatients';

  @override
  State<VPEDeferredPatientsWidget> createState() =>
      _VPEDeferredPatientsWidgetState();
}

class _VPEDeferredPatientsWidgetState extends State<VPEDeferredPatientsWidget> {
  late VPEDeferredPatientsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VPEDeferredPatientsModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.createPatientTimeButtonVPEDeferredLog =
      ...
      if ((_model.createPatientTimeButtonVPEDeferredLog?.succeeded ?? true)) {
        _model.patientTimerLogId = PEPAPIsGroup.createPatientTimerLogCall
            .timeLogId(
              (_model.createPatientTimeButtonVPEDeferredLog?.jsonBody ?? ''),
            )
            ?.toString();
        safeSetState(() {});
      }
      ...
      _model.getVPEDeferredPatients = await GQLgetByFunctionCall.call(
        hasuraToken: FFAppState().hasuraToken,
        requestBody: functions
            .getVPEDeferredPataients(FFAppState().patientID)
            .toString(),
      );
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            ...
                            context.pushNamed(VPEDashboardWidget.routeName);
                          },
                        ),
                        ClipRRect(
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'Virtual Patient Enroller (VPE) - Deferred Patients',
                                                  ...
                                                  if (_model
                                                    ...
                                                    if (((_model.sessionTimerMilliseconds1 ~/
                                                      ...
                                                      safeSetState(() {});
                                                            ...
                                                            60) ==
                                                        0) {
                                                      _model.updatePatientTimerPlayBtnVpe =
                                                          await PEPAPIsGroup
                  ...
                  if (!FFAppState().noPatientsAvailable)
                    Align(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: FFAppState().vpeDeferredPatientsCache(
                                                                      ...
                                                                      callback:
                                                                        ...
                                                                        if (_model
                                                                          ...
                                                                          _model
                                                                              .sessionTimerController2
                                                                              .onStartTimer();
                                                                          if (((_model.sessionTimerMilliseconds1 ~/ 1000) % 60) ==
                                                                              0) {
                                                                            _model.updatePatientTimerPlayButton =
                                                                                await PEPAPIsGroup.updateTimerLogCall.call(
                                                                              duration: _model.sessionTimerMilliseconds1 ~/ 1000,
                                                                              userId: FFAppState().loginProfileID,
                                                                              timelogId: FFAppState().timerlogId,
                                                                            ...
                                                                            safeSetState(() {});
                                                                              ...
                                                                              0) {
                                                                            _model.updatePatientTimerPlayBtn =
                                                                                await PEPAPIsGroup.updatePatientTimerLogCall.call(
                                                                              duration: _model.sessionTimerMilliseconds2 ~/ 1000,
                                                                              userId: FFAppState().loginProfileID,
                                                                              authToken: FFAppState().loginToken,
                                                                                    ...
                                                                                    child: GestureDetector(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: CallPatientWidget(
                                                                                          ...
                                                                                          outboundNumbers: List.generate(random_data.randomInteger(5, 5), (index) => random_data.randomName(true, true)),
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                                  );
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: (FFAppState()
                                                          ...
                                                          : () async {
                                                              if (FFAppState()
                                                                  .transferPatient) {
                                                                _model.invalidateTransferDeferredPatientDetails =
                                                                    await PEPAPIsGroup
                                                                        .invalidateTransferredPatientCall
                                                                        .call(
                                                                  loginID: int.parse(
                                                                ...
                                                                if ((_model
                                                                        .invalidateTransferDeferredPatientDetails
                                                                        ?.succeeded ??
                                                                    true)) {
                                                                  _model.transferredPatientId =
                                                                      null;
                                                                ...
                                                                if (_model.commentTextController
                                                                            .text !=
                                                                        '') {
                                                                  _model.saveTransferDeferredPatientDetails =
                                                                      await PEPAPIsGroup
                                                                    ...
                                                                    requestBody: functions.patientUpdateGlobal(
                                                                        ...
                                                                        (_model.tfMobileNumberFocusNode?.hasFocus ?? false).toString(),
                                                                  ...
                                                                  if ((_model
                                                                          .saveTransferDeferredPatientDetails
                                                                          ?.succeeded ??
                                                                      true)) {
                                                                    _model.transferredPatientId =
                                                                        PEPAPIsGroup
                                                                ...
                                                                if (_model.commentTextController
                                                                  ...
                                                                  if ((_model.textController1.text !=
                                                                    ...
                                                                    if (PEPAPIsGroup
                                                                          ...
                                                                          (_model.updateDeferredPatient?.jsonBody ??
                                                                              ''),
                                                                        ) ==
                                                                        true) {
                                                                      FFAppState()
                                                ...
                                                FFButtonWidget(
                                                  onPressed: (FFAppState()
                                                      ...
                                                      : () async {
                                                          ...
                                                          safeSetState(() {});
                                                          FFAppState()
                                                              .clearVpeDeferredPatientsCacheCache();
                                                          FFAppState()
                                                              .clearCcmStatusUpdateDeferredVpeCache();
