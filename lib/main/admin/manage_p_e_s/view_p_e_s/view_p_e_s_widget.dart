...
import '/main/admin/manage_p_e_s/add_p_e_s/add_p_e_s_widget.dart';
import '/main/admin/manage_p_e_s/update_p_e_s/update_p_e_s_widget.dart';
...
import 'view_p_e_s_model.dart';
export 'view_p_e_s_model.dart';

class ViewPESWidget extends StatefulWidget {
  const ViewPESWidget({super.key});

  static String routeName = 'ViewPES';
  static String routePath = 'PEAdmin';

  @override
  State<ViewPESWidget> createState() => _ViewPESWidgetState();
}

class _ViewPESWidgetState extends State<ViewPESWidget> {
  late ViewPESModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewPESModel());
      ...
      child: Scaffold(
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 8.0, 0.0, 0.0),
                          child: Text(
                            'Patient Enrollment Specialist (PES) Admin',
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: FFAppState().patientEnrollmentList(
              requestFn: () => GQLgetByFunctionCall.call(
                hasuraToken: FFAppState().hasuraToken,
                requestBody: functions.getPatientEnrollerDetails().toString(),
              ),
            ),
                  ...
                  children: [
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.goNamed(
                                        ManageClinicTimeSlotsWidget.routeName);
                                  },
                                  text: 'Manage Clinic Appointment Slots',
                                  options: FFButtonOptions(
                                    height: 40.0,
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        24.0, 0.0, 24.0, 0.0),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final patientEnrollerList =
                                GQLgetByFunctionCall.patientEnrollerList(
                            ...
                            return FlutterFlowDataTable<dynamic>(
                              ...
                              dataRowBuilder: (patientEnrollerListItem,
                                      patientEnrollerListIndex,
                                      selected,
                                      onSelectChanged) =>
                                  DataRow(
                                color: WidgetStateProperty.all(
                                  patientEnrollerListIndex % 2 == 0
                                      ? FlutterFlowTheme.of(context)
                                          .secondaryBackground
                                      : FlutterFlowTheme.of(context)
                                          .primaryBackground,
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    _model.allClinics =
                                                      ...
                                                      hasuraToken: FFAppState()
                                                          .hasuraToken,
                                                      requestBody:
                                                          '{\"query\":\"query MyQuery { pep_vw_available_clinics { clinic_id clinic_name patient_clinic_timezone has_active_enroller } }\"}',
                                                    );
                                                  ...
                                                  var confirmDialogResponse =
                                                      await showDialog<bool>(
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                content: Text(
                                                                    'Are you sure you want to delete the Patient Enrollment Specialist?'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                                  ...
                                                  if (confirmDialogResponse) {
                                                    ...
                                                    if ((_model.deletePes
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'Deleted Patient Enrollerment  Specialist  Sucessfully.',
                                                            style: TextStyle(
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'Deleting Patient Enrollerment  Specialist Failed.Please Try Again!',
                                                            style: TextStyle(
                                                              color: FlutterFlowTheme
                                                                      .of(context)
                                                                  .buttonText,
