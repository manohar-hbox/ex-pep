...
import 'update_p_e_s_model.dart';
export 'update_p_e_s_model.dart';

class UpdatePESWidget extends StatefulWidget {
  const UpdatePESWidget({
    super.key,
    required this.firstName,
    required this.lastName,
    required this.email,
    required this.clinicIDs,
    required this.patientEnrollerID,
    this.taskAssigned,
  ...
  final int? patientEnrollerID;
  final bool? taskAssigned;
  final bool? followUpTasks;

  @override
  State<UpdatePESWidget> createState() => _UpdatePESWidgetState();
}

class _UpdatePESWidgetState extends State<UpdatePESWidget> {
  late UpdatePESModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatePESModel());
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Update Patient Enroller Details',
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.passwordTextController.text ==
                                    ...
                                    _model.updatePES =
                                        await PEPAPIsGroup.updatePESCall.call(
                                      authToken: FFAppState().loginToken,
                                      adminId: int.parse(
                                          FFAppState().loginProfileID),
                                      patientEnrollerId:
                                          widget.patientEnrollerID,
                                    ...
                                    if ((_model.updatePES?.succeeded ?? true)) {
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        SnackBar(
                                          content: Text(
                                            'Updated Patient Enrollment Specialist Successfully.',
                                            style: TextStyle(
                                              color:
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Updating Patient Enrollment Specialist Failed. Please Try Again!',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .buttonText,
                                    ...
                                    context.pushNamed(ViewPESWidget.routeName);
                                  } else {
