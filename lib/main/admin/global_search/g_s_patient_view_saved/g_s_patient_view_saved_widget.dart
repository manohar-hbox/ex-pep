...
import 'g_s_patient_view_saved_model.dart';
export 'g_s_patient_view_saved_model.dart';

class GSPatientViewSavedWidget extends StatefulWidget {
  const GSPatientViewSavedWidget({
    super.key,
  ...
  static String routeName = 'GSPatientViewSaved';
  static String routePath = 'GSPatientViewSaved';

  @override
  State<GSPatientViewSavedWidget> createState() =>
      _GSPatientViewSavedWidgetState();
}

class _GSPatientViewSavedWidgetState extends State<GSPatientViewSavedWidget>
    with TickerProviderStateMixin {
  late GSPatientViewSavedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GSPatientViewSavedModel());
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: SendSMSWidget(
                                                                                ...
                                                                                }(_model.mobilePhoneTextController.text)
                                                                                    ? ''
                                                                                    : _model.mobilePhoneTextController.text,
                                                              ...
                                                              child: Align(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                      TextFormField(
                                                                    controller:
                                                                        _model.homePhoneTextController ??=
                                                                            TextEditingController(
                                                                      text: (String?
                                                                          inputString) {
                                                                        return (inputString == "null" ||
