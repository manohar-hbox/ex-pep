...
import 'create_new_group_i_i_model.dart';
export 'create_new_group_i_i_model.dart';

class CreateNewGroupIIWidget extends StatefulWidget {
  const CreateNewGroupIIWidget({super.key});

  static String routeName = 'CreateNewGroupII';
  static String routePath = 'createNewGroupII';

  @override
  State<CreateNewGroupIIWidget> createState() => _CreateNewGroupIIWidgetState();
}

class _CreateNewGroupIIWidgetState extends State<CreateNewGroupIIWidget> {
  late CreateNewGroupIIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNewGroupIIModel());
    ...
    _model.zipcodesTextController ??= TextEditingController();
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<int>(
                                ...
                                onChanged: (val) async {
                                  ...
                                  _model.secondaryFiltersApplied = false;
                                  safeSetState(() {});
                            ...
                            onPressed: !_model.applyEnabled
                                ...
                                : () async {
                                    if (_model.clinicSelectValue != null) {
                                      ...
                                      _model.primDxDropDown =
                                          GQLgetByFunctionCall.primaryDxList(
                                        (_model.getPrimDx?.jsonBody ?? ''),
                                      )!
                                              .toList()
                                              .cast<String>();
                                      _model.secDxDropDown =
                                          GQLgetByFunctionCall.secondaryDxList(
                                      ...
                                      _model.primInsDropDown =
                                        ...
                                        (_model.getPrimIns?.jsonBody ?? ''),
                                              ...
                                              .cast<String>();
                                      _model.secInsDropDown =
                                          GQLgetByFunctionCall.secondaryInsList(
                          ...
                          children: [
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                margin: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 4.0, 16.0, 4.0),
                                hidesUnderline: true,
                                disabled: !(_model.primDxDropDown.isNotEmpty),
                                isOverButton: true,
                                isSearchable: true,
                                isMultiSelect: true,
                                onMultiSelectChanged: (val) async {
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                margin: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 4.0, 16.0, 4.0),
                                hidesUnderline: true,
                                disabled: !(_model.secDxDropDown.isNotEmpty),
                                isOverButton: true,
                                isSearchable: true,
                                isMultiSelect: true,
                                onMultiSelectChanged: (val) async {
                                  ...
                                  if (_model.secondaryDxSelectValue != null &&
                                      (_model.secondaryDxSelectValue)!
                                          .isNotEmpty) {
                                    _model.primInsDropDown = [];
                                    _model.secInsDropDown = [];
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                isMultiSelect: true,
                                onMultiSelectChanged: (val) => safeSetState(
                                    () => _model.programEligibilitySelectValue =
                                        val),
                              ),
                            ),
                          ].divide(SizedBox(width: 20.0)),
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                margin: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 4.0, 16.0, 4.0),
                                hidesUnderline: true,
                                disabled: !(_model.primInsDropDown.isNotEmpty),
                                isOverButton: true,
                                isSearchable: true,
                                isMultiSelect: true,
                                onMultiSelectChanged: (val) async {
                                  safeSetState(() =>
                                      _model.primaryInsuranceSelectValue = val);
                                  safeSetState(() {
                                    _model
                                        .secondaryInsuranceSelectValueController
                                        ?.reset();
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                margin: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 4.0, 16.0, 4.0),
                                hidesUnderline: true,
                                disabled: !(_model.secInsDropDown.isNotEmpty),
                                isOverButton: true,
                                isSearchable: true,
                                isMultiSelect: true,
                                onMultiSelectChanged: (val) async {
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                margin: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 4.0, 16.0, 4.0),
                                hidesUnderline: true,
                                disabled: !(_model.insTypeDropDown.isNotEmpty),
                                isOverButton: true,
                                isSearchable: true,
                                isMultiSelect: true,
                                onMultiSelectChanged: (val) => safeSetState(
                                    () =>
                                        _model.insuranceTypeSelectValue = val),
                              ),
                            ),
                          ].divide(SizedBox(width: 20.0)),
                        ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Container(
                                width: 620.0,
                                child: TextFormField(
                                  controller: _model.zipcodesTextController,
                                ...
                                if (_model.clinicSelectValue != null) {
                                    ...
                                    requestBody: functions
                                        .generateFilteredPatients(
                                            ...
                                            _model.insuranceTypeSelectValue
                                                ?.toList(),
                                            _model.zipcodesTextController.text,
                                            _model.datePicked)
                                        .toString(),
                                  );
                                  ...
                                  if ((_model.applyResponse?.succeeded ??
                                    ...
                                    FFAppState().filteredPatients =
                                        GQLgetByFunctionCall.consolidatedData(
                                    ...
                                    _model.groupFiltersUsed =
                                        functions.groupFiltersUsed(
                                            ...
                                            _model.providerSelectValue
                                                ?.toList());
                                    _model.secondaryFiltersApplied = true;
                                    safeSetState(() {});
                                  }
                                } else {
                            ...
                            Container(
                              ...
                              child: Autocomplete<String>(
                                ...
                                onSelected: (String selection) {
                                  safeSetState(() => _model
                                      .patientSearchSelectedOption = selection);
                                  FocusScope.of(context).unfocus();
                                },
                                fieldViewBuilder: (
                                  context,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (getJsonField(
                                    ...
                                    FFAppState().addToAddedPPCIDs(getJsonField(
                                      (_model.pcdID?.jsonBody ?? ''),
                                      r'''$.data.pep_vw_consolidated_data[:].patient_clinic_data_id''',
                                    ));
                                    safeSetState(() {});
                          ...
                          children: [
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      'Enter Number of Patients To Be Displayed*',
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        font: GoogleFonts.poppins(
                            ...
                            FFButtonWidget(
                              onPressed: (_model.numberOfPatientsTextController
                                              .text ==
                                          '')
                                  ? null
                                  : () async {
                                      ...
                                      _model.patientDetails = null;
                                      safeSetState(() {});
                                      _model.patientClinicDataIDs = functions
                                          .subsetPatients(
                                              FFAppState()
                                                  .filteredPatientsCount,
                                              int.parse(_model
                                          ...
                                          .cast<int>();
                                      safeSetState(() {});
                                      _model.getCreateGroupPatientList =
                                          await GQLgetByFunctionCall.call(
                                        hasuraToken: FFAppState().hasuraToken,
                                        requestBody: functions
                                            .getCreateGroupPatientList(_model
                                                .patientClinicDataIDs
                                                .toList())
                                            .toString(),
                                      );

                                      _model.patientDetails = (_model
                                              .getCreateGroupPatientList
                                              ?.jsonBody ??
                                          '');
                                      safeSetState(() {});
                            ...
                            child: FFButtonWidget(
                              onPressed: !((_model.txtfldEnterGroupNameTextController
                                      ...
                                      (_model.numberOfPatientsTextController
                                                  .text !=
                                              '') &&
                                      _model.secondaryFiltersEnabled &&
                                      _model.secondaryFiltersApplied)
                                  ? null
                                  : () async {
                                      _model.createGroup = await PEPAPIsGroup
                                          .createGroupCall
                                          .call(
                                        name: _model
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              safeSetState(() {
                                ...
                                _model.secondaryDxSelectValueController
                                    ?.reset();
                                _model.programEligibilitySelectValueController
                                    ?.reset();
                                _model.primaryInsuranceSelectValueController
                                    ?.reset();
                                _model.secondaryInsuranceSelectValueController
                                    ?.reset();
                                _model.insuranceTypeSelectValueController
                                    ?.reset();
