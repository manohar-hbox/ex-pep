...
import '/index.dart';
import 'create_new_group_i_i_widget.dart' show CreateNewGroupIIWidget;
import 'package:flutter/material.dart';

class CreateNewGroupIIModel extends FlutterFlowModel<CreateNewGroupIIWidget> {
  ...
  bool secondaryFiltersApplied = false;
  ...
  // Stores action output result for [Backend Call - API (GQLgetClinicNames)] action in CreateNewGroupII widget.
