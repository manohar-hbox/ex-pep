...
import 'duplicate_group_model.dart';
export 'duplicate_group_model.dart';
...
class DuplicateGroupWidget extends StatefulWidget {
  ...
  static String routeName = 'DuplicateGroup';
  static String routePath = 'duplicateGroup';
...
class _DuplicateGroupWidgetState extends State<DuplicateGroupWidget> {
  late DuplicateGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DuplicateGroupModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.autofillValuesPageLoad = await GQLgetByFunctionCall.call(
        hasuraToken: FFAppState().hasuraToken,
        requestBody:
            functions.autofillSearch(widget.clinicID!, '|').toString(),
      );
      ...
      _model.autoFillSearch = (_model.autofillValuesPageLoad?.jsonBody ?? '');
      safeSetState(() {});
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Virtual Patient Enrollment(VPE) - Duplicate Group',
                                        ...
                                        if (_model.clinicSelectValue != null) {
                                          ...
                                          _model.insTypeDropDown =
                                            ...
                                            (_model.getInsType?.jsonBody ?? ''),
                                                  ...
                                                  .toList()
                                                  .cast<String>();
                                          _model.autoFillSearch = (_model
                                                  .autofillValues?.jsonBody ??
                                              '');
                                          safeSetState(() {});
                                          _model.secondaryFiltersEnabled = true;
                                          safeSetState(() {});
