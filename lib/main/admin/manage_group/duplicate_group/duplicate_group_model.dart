...
import '/index.dart';
import 'duplicate_group_widget.dart' show DuplicateGroupWidget;
import 'package:flutter/material.dart';

class DuplicateGroupModel extends FlutterFlowModel<DuplicateGroupWidget> {
  ...
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in DuplicateGroup widget.
  ApiCallResponse? groupDetails;
  // Stores action output result for [Backend Call - API (GQLgetClinicNames)] action in DuplicateGroup widget.
  ApiCallResponse? getClinics;
  // Stores action output result for [Backend Call - API (GQLgetFacilityNames)] action in DuplicateGroup widget.
  ApiCallResponse? getFacilityDP;
  // Stores action output result for [Backend Call - API (GQLgetProviderList)] action in DuplicateGroup widget.
  ...
  // Stores action output result for [Backend Call - API (GQLgetByFunction)] action in DuplicateGroup widget.
  ApiCallResponse? autofillValuesPageLoad;
