...
import 'create_new_group_model.dart';
export 'create_new_group_model.dart';

class CreateNewGroupWidget extends StatefulWidget {
  const CreateNewGroupWidget({super.key});

  static String routeName = 'CreateNewGroup';
  static String routePath = 'createNewGroup';

  @override
  State<CreateNewGroupWidget> createState() => _CreateNewGroupWidgetState();
}

class _CreateNewGroupWidgetState extends State<CreateNewGroupWidget> {
  late CreateNewGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNewGroupModel());
                          ...
                          Align(
                            ...
                            child: Switch.adaptive(
                              ...
                              onChanged: (newValue) async {
                                ...
                                if (newValue) {
                                  FFAppState().filteredPatientsList = functions
                                  ...
                                  FFAppState().filteredPatientsList = functions
                                      ...
                                      .cast<int>();
                                  safeSetState(() {});
                                  FFAppState().filteredPatientsCount = functions
                                ...
                                if (_model.clinicSelectValue != null) {
                                  ...
                                  if ((_model.applyResponse?.succeeded ??
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          content: Text(functions.getClinicName(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            width: 460.0,
                            child: TextFormField(
                              controller: _model.numberOfPatientsTextController,
                            ...
                            onPressed: !((_model.txtfldEnterGroupNameTextController
                                ...
                                : () async {
                                    _model.createGroup =
                                      ...
                                      patientIdsList: functions.subsetPatients(
                                          FFAppState().filteredPatientsCount,
                                          int.parse(_model
