...
import '/index.dart';
import 'create_new_group_widget.dart' show CreateNewGroupWidget;
import 'package:flutter/material.dart';

class CreateNewGroupModel extends FlutterFlowModel<CreateNewGroupWidget> {
  ...
  // Stores action output result for [Backend Call - API (GQLgetClinicNames)] action in CreateNewGroup widget.
