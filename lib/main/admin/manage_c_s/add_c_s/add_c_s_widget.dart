...
import 'add_c_s_model.dart';
export 'add_c_s_model.dart';

class AddCSWidget extends StatefulWidget {
  const AddCSWidget({super.key});

  @override
  State<AddCSWidget> createState() => _AddCSWidgetState();
}

class _AddCSWidgetState extends State<AddCSWidget> {
  late AddCSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCSModel());
              ...
              FutureBuilder<ApiCallResponse>(
                future: FFAppState().clinicsWithoutActiveEnroller(
                  requestFn: () => GQLgetByFunctionCall.call(
                    ...
                    requestBody:
                        '{\"query\":\"query MyQuery { pep_vw_available_clinics(where: {has_active_cs: {_neq: true}}) { clinic_id clinic_name patient_clinic_timezone has_active_cs } }\"}',
                  ),
                ),
                                    ...
                                    onPressed: ((getJsonField(
                                        ...
                                        : () async {
                                            ...
                                            if (_model.passwordTextController
                                              ...
                                              if ((_model.createCS?.succeeded ??
                                                  true)) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                                  SnackBar(
                                                    content: Text(
                                                      ' Created Care Specialist Successfully',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Adding Care Specialist Failed.Please Try Again!',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
