...
import 'update_c_s_model.dart';
export 'update_c_s_model.dart';

class UpdateCSWidget extends StatefulWidget {
  const UpdateCSWidget({
    super.key,
    required this.firstName,
    required this.lastName,
    required this.email,
    required this.clinicIDs,
    required this.careSpecialistID,
    this.taskAssigned,
    this.followUpTasks,
  });
  ...
  final int? careSpecialistID;
  final bool? taskAssigned;
  final bool? followUpTasks;

  @override
  State<UpdateCSWidget> createState() => _UpdateCSWidgetState();
}

class _UpdateCSWidgetState extends State<UpdateCSWidget> {
  late UpdateCSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateCSModel());
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Update Care Specialist Details',
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Theme(
                        ...
                        child: Checkbox(
                          value: _model.deferredValue ??= widget.taskAssigned!,
                          onChanged: (newValue) async {
                            safeSetState(
                                () => _model.deferredValue = newValue!);
                          },
                    ...
                    Padding(
                      ...
                      child: Theme(
                        ...
                        child: Checkbox(
                          value: _model.followUpValue ??=
                              widget.followUpTasks!,
                          onChanged: (newValue) async {
                            safeSetState(
                                () => _model.followUpValue = newValue!);
                          },
                          side: (FlutterFlowTheme.of(context).secondaryText !=
                                  null)
                              ? BorderSide(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              10.0, 0.0, 0.0, 0.0),
                          child: TextFormField(
                            controller: _model.rePasswordTextController,
                            ...
                            textAlign: TextAlign.justify,
                            cursorColor: FlutterFlowTheme.of(context).tertiary,
                            validator: _model.rePasswordTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
              ...
              if (getJsonField(
                    FFAppState().UpdateAvailClinics,
                    r'''$.pep_vw_available_clinics[:].clinic_id''',
                  ) !=
                  null)
                Align(
                  alignment: AlignmentDirectional(0.0, -1.0),
                  child: Padding(
                    ...
                    child: FlutterFlowDropDown<int>(
                      multiSelectController:
                          _model.clinicSelectValueController ??=
                              FormListFieldController<int>(
                                  _model.clinicSelectValue ??= List<int>.from(
                        widget.clinicIDs ?? [],
                      )),
                      ...
                      optionLabels: (getJsonField(
                        FFAppState().UpdateAvailClinics,
                        r'''$.pep_vw_available_clinics[:].clinic_name''',
                        true,
                      ) as List)
                      ...
                      onMultiSelectChanged: (val) =>
                          safeSetState(() => _model.clinicSelectValue = val),
                    ),
                  ),
                ),
              if (getJsonField(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.passwordTextController.text ==
                                ...
                                _model.updateCS =
                                    await PEPAPIsGroup.updateCSCall.call(
                                  authToken: FFAppState().loginToken,
                                  adminId:
                                      int.parse(FFAppState().loginProfileID),
                                  careSpecialistId: widget.careSpecialistID,
                                  requestBody: functions
                                      .generateUpdateUserBody(
                                          ...
                                          _model.clinicSelectValue?.toList(),
                                ...
                                if ((_model.updateCS?.succeeded ?? true)) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        ' Updated Care Specialist Succesfully.',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .buttonText,
                                        ),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        ' Updating Care Specialist Failed.Please Try Again!',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .buttonText,
                                        ),
                                ...
                                FFAppState().clearCareSpecialistListCache();

                                context.pushNamed(ViewCSWidget.routeName);
                              } else {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
