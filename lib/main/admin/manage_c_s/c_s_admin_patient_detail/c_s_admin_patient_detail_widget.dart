...
import 'c_s_admin_patient_detail_model.dart';
export 'c_s_admin_patient_detail_model.dart';

class CSAdminPatientDetailWidget extends StatefulWidget {
  const CSAdminPatientDetailWidget({
    super.key,
  ...
  static String routeName = 'CSAdminPatientDetail';
  static String routePath = 'CSAdminPatientDetails';

  @override
  State<CSAdminPatientDetailWidget> createState() =>
      _CSAdminPatientDetailWidgetState();
}

class _CSAdminPatientDetailWidgetState extends State<CSAdminPatientDetailWidget>
    with TickerProviderStateMixin {
  late CSAdminPatientDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSAdminPatientDetailModel());
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            patientId:
                                                                                widget.patientClinicDataID!.toString(),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                    );
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Column(
                                                        mainAxisSize:
                                                            MainAxisSize.max,
                                                        children: [
                                                          if (functions.isPatientAlreadyEnrolled(
                                                              GQLgetByFunctionCall
                                                                      .ccmStatusUpdates(
                                                                  ...
                                                                  if (getJsonField(
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child: FlutterFlowDropDown<
                                                                          String>(
                                                                        controller:
                                                                            _model.rPMAppDateValueController ??=
                                                          ...
                                                          if (_model.commentTextController
                                                            ...
                                                            if (((((_model.ccmStatus ==
                                                                ...
                                                                (((_model.rpmStatus ==
                                                                        ...
                                                                        ((_model.facilityValue !=
                                                                                null) &&
                                                                            (_model.rPMAppDateValue != null &&
                                                                                _model.rPMAppDateValue !=
                                                                                    '') &&
                                                                            (_model.rPMAppTimeValue != null &&
                                                                                _model.rPMAppTimeValue !=
                                                                                    ''))) ||
                                                                    (_model.rpmStatus !=
                                                                        (2)))) {
