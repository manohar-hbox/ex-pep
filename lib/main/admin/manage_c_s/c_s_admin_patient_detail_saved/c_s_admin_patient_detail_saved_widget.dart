...
import 'c_s_admin_patient_detail_saved_model.dart';
export 'c_s_admin_patient_detail_saved_model.dart';

class CSAdminPatientDetailSavedWidget extends StatefulWidget {
  const CSAdminPatientDetailSavedWidget({
    super.key,
  ...
  static String routeName = 'CSAdminPatientDetailSaved';
  static String routePath = 'CSAdminPatientDetailsSaved';

  @override
  State<CSAdminPatientDetailSavedWidget> createState() =>
      _CSAdminPatientDetailSavedWidgetState();
}

class _CSAdminPatientDetailSavedWidgetState
    extends State<CSAdminPatientDetailSavedWidget>
    with TickerProviderStateMixin {
  late CSAdminPatientDetailSavedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSAdminPatientDetailSavedModel());
                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          return FlutterFlowDataTable<
                                                                            ...
                                                                            dataRowBuilder: (ccmStatusUpdatesItem, ccmStatusUpdatesIndex, selected, onSelectChanged) =>
                                                                                DataRow(
                                                                              cells: [
                                                                                Align(
                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          return FlutterFlowDataTable<
                                                                            ...
                                                                            dataRowBuilder: (rpmStatusUpdatesItem, rpmStatusUpdatesIndex, selected, onSelectChanged) =>
                                                                                DataRow(
                                                                              cells: [
                                                                                Align(
                                                                                  alignment: AlignmentDirectional(-1.0, 0.0),
